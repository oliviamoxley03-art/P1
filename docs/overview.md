...
**Cross-Cultural Conventions**– Items like date order and address conventions vary by country, but many native-speaking resources assume this is common knowledge. For example, in Spanish, dates follow Day/Month/Year, whereas English business letters require a Month/Day/Year format. 
...
This guide also allows **[translanguaging](https://www.edweek.org/teaching-learning/what-is-translanguaging-and-how-is-it-used-in-the-classroom/2023/07.),** meaning students may use Spanish to plan, discuss, and use dictionaries, then write the final letter in English.
